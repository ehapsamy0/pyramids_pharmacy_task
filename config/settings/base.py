...
APPS_DIR = BASE_DIR / "pharmacy_management_system"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "pharmacy_management_system.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "pharmacy_management_system.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""ehab samy""", "ehab-samy@pyramidspharmacy.com")]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "pharmacy_management_system.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "pharmacy_management_system.users.forms.UserSignupForm"}
...
DRF_STANDARDIZED_ERRORS = {
    "EXCEPTION_FORMATTER_CLASS": "config.exception_handlers.DRFExceptionFormatter",
}
